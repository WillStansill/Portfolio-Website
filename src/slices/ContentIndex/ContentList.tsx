...
const handleMouseMove = (e: MouseEvent) => {
  ...
  // calculate speed and directions
      ...
      >
        {items.map((item, index) =>(
          ...
          {isFilled.keyText(item.data.title) &&(
            ...
            <Link 
            href={urlPrefixes + "/" + item.uid} className="flex flex-col justify-between border-t border-t-slate-100 py-10 text-slate-200 md:flex-row"
